...
const ROLE_PERMISSIONS: Record<StaffRole, readonly Permission[]> = {
  SYSTEM_ADMIN: [...REHABILITATION_SPECIALIST, ...ADMIN_PERMISSIONS, ...SYSTEM_ADMIN],
  ORGANIZATION_ADMIN: [...REHABILITATION_SPECIALIST, ...ADMIN_PERMISSIONS],
