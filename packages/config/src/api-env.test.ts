...
describe('parseApiEnv', () => {
  ...
  it('accepts a complete hardened production configuration', () => {
    const env = parseApiEnv({
      ...
      EMAIL_PROVIDER: 'gmail-api', EMAIL_FROM: 'sender@example.com',
      GMAIL_API_CLIENT_ID: 'client-id', GMAIL_API_CLIENT_SECRET: 'client-secret', GMAIL_API_REFRESH_TOKEN: 'refresh-token',
